...
public class RestTestController {
	...
	//MyBatis의 SelectAll + keyword Choose 활용
	//ResponseEntity를 이용해 null값의 경우 에러로 보내기
	...
	public ResponseEntity<List<Map<String,Object>>> func5(String condition, String type, String keyword)
	{
		...
		{
			result = ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(list);	//502
		}
		...
		else	//condition 파라미터 값이 있는 경우
		{
			...
			list = service.SelectAllChoose(map);
